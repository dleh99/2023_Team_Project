...
//ID3D12Resource* CreateTextureResourceFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList,
//	wchar_t* pszFileName, D3D12_RESOURCE_STATES d3dResourceStates, ID3D12Resource** ppd3dUploadBuffer)
//{
...
//		&pd3dTexture, ddsData, vSubresources, &ddsAlphaMode, &blsCubeMap);
//
//	D3D12_HEAP_PROPERTIES d3dHeapPropertiesDesc;
//	::ZeroMemory(&d3dHeapPropertiesDesc, sizeof(D3D12_HEAP_PROPERTIES));
//	d3dHeapPropertiesDesc.Type = D3D12_HEAP_TYPE_UPLOAD;
